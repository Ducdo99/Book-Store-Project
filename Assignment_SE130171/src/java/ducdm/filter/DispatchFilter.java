...
public class DispatchFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //convert request raw into request object
        HttpServletRequest reqObject = (HttpServletRequest) request;
        //get link on address bar 
        String uri = reqObject.getRequestURI();
        try {
            int lastIndex = uri.lastIndexOf("/");
            //get resource name after "/" character. It's also the key in siteMap
            ...
            if (url != null) {
                RequestDispatcher rd = reqObject.getRequestDispatcher(url);
...
//            problem = t;
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("DispatchFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("DispatchFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("DispatchFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("DispatchFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("DispatchFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
